...
export default function ContactPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Cảm ơn ${form.name}, Mobile Store đã nhận được tin nhắn hỗ trợ của bạn!`);
  ...
  return (
    <div className="contact-wrapper">
            ...
            <div className="contact-form-panel">
              ...
              <form onSubmit={handleSubmit}>
                <div className="form-group">
                  ...
                  <input type="text" name="name" placeholder="Nguyễn Văn A" value={form.name} onChange={handleChange} required />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <textarea name="message" rows="4" placeholder="Nhập thắc mắc hoặc yêu cầu..." value={form.message} onChange={handleChange} required></textarea>
                </div>
      ...
      {/* Thêm Footer nếu project của bạn có PageFooter */}
    </div>
  );
}